...
const About = () => {
  ...
  return (
    <section className="w-full mx-auto bg-[#FFFFFF] min-h-[100vh] py-24 px-24">
      <h1 className="text-[32px] w-[70%] mx-auto text-center lg:text-[50px] lg:leading-[65px] text-[#2F2F2F] font-bold">
        Swift customer service that transforms your business
      </h1>

      <div className="my-16 flex w-full mx-auto">
      ...
      <div className="my-12 flex flex-row w-full p-4 px-16 bg-[#a8e7f0] items-center space-x-4 justify-between">
        ...
        <div className="flex-[0.5] space-y-4">
          ...
          <h2 className="text-[24px] text-[#2F2F2F] font-bold leading-[35px]">
            Unraveling Customer Service Challenges with BridgeChat AI
          </h2>
          <p className="text-[18px] text-[#525866] leading-[35px]">
